...
public class TcpServer01 {
	...
	public static void main(String[] args) throws IOException {
		// TCP소텟 통신을 하기 위해 ServerSocket객체를 생성한다.
		...
		// ==> 클라이언트의 연결 요청이 오면 새로은 Socket객체를 생성해서
		//		클라이언트의 Socket과 연결한다.
		Socket socket = server.accept();
		
		// 위의 accept()메서드 이후의 내용은 클라이언트와 연결된 상테에서 실행되는 코드이다.
		...
		// 메시지 보내기 ==> 스트림을 이용한 출력 작업이 곧 송신 작업된다.
